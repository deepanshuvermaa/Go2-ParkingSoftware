# Go2 Parking APK Build Script (Quickbill Method)
Write-Host "========================================" -ForegroundColor Green
Write-Host "Go2 Parking APK Build (Quickbill Method)" -ForegroundColor Green
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    if (Test-Path $apkPath) {
        ...
        $destinationPath = "$PSScriptRoot\go2-parking-release.apk"
